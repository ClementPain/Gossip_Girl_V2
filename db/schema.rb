...
ActiveRecord::Schema.define(version: 2020_08_05_083639) do
  ...
  create_table "likes", force: :cascade do |t|
    t.bigint "user_id"
    t.string "element_liked_type"
    t.bigint "element_liked_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["element_liked_type", "element_liked_id"], name: "index_likes_on_element_liked_type_and_element_liked_id"
